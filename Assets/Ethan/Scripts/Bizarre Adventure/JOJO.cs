...
public class JOJO :MonoBehaviour
{
    ...
    public void LoadPlayer(Player_Movement player_movement, Player_Health player_Health)
    {
        ...
        player_Health.playerLives = data.playerLives;
    ...
    {
        SavePlayer(GetComponent<Player_Movement>(), GetComponent<Player_Health>());
    }
    private void Awake()
    {
        LoadPlayer(GetComponent<Player_Movement>(), GetComponent<Player_Health>());
    }
}
